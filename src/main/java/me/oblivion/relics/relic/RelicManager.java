...
public class RelicManager {
    ...
    public RelicType getRelic(UUID uuid) {
        ...
        String relicName =
                playerDataManager.getRelic(uuid);
        ...
        try {
            return RelicType.valueOf(
                    relicName.toUpperCase()
            );
    ...
    public ItemStack createRelicItem(
            RelicType relic
    ) {
    ...
    public RelicType getRelicFromItem(
            ItemStack item
    ) {
